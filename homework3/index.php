...
<html>
	...
	<body>
		...
		<section class="foto" >
			<div class="left"><a href="#"><img src="img/left.png" alt="arrow1"></a></div>
			<div class="right"><a href="#"><img src="img/right.png" alt="arrow2"></a></div>
			<div class="text">
		...
		<section class="base posts">
			...
			<div class="first">
				...
				<div class="box">
					<a class="ab" href="#"><img src="img/first.jpg" alt="img1"></a>
					<div class="after">
			...
			<div class="second">
				...
				<div class="box">
					<a class="aa" href="#"><img src="img/second.jpg" alt="img2"></a>
					<div class="after">
